...
2. Submit: `https://github.com/YOUR_USERNAME/laravel-common`
...
```markdown
[![Tests](https://github.com/YOUR_USERNAME/laravel-common/actions/workflows/tests.yml/badge.svg)](https://github.com/YOUR_USERNAME/laravel-common/actions/workflows/tests.yml)
[![Latest Version on Packagist](https://img.shields.io/packagist/v/carone/laravel-common.svg?style=flat-square)](https://packagist.org/packages/carone/laravel-common)
```
